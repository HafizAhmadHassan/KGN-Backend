...
print("Conncection Success to DB")
cursor = db.cursor()
# Retrieve arguments passed from the calling script
arg1 = sys.argv[1]
print("this is Arguement" , arg1)
sql_q='SELECT * FROM kgnWebApp_plcdata where id=' + str(arg1)
...
for row in result_set:
    for val in row:
        list1.append(val)
print("Success to Get Row",type(row),len(row[1:]),row[1:][0])
list1=list1[1:]  
